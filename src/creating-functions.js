...
// TODO: write code below
function capitilizeString(input) {
  let result = input[0].toUpperCase() + input.substring(1);
  return result
}
...
//
// TODO: write code below
function hiSmile(name) {
  return 'Hi, ' + capitilizeString(name) + ' :)'
}
...
module.exports = {
  ...
  b: capitilizeString, // 2. change undefined to be the name of the function you defined for the second TODO)
  c: hiSmile, // etc
  d: howManyStrings,
  e: addEdwardProperty
}
